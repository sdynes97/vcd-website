...
';
    ...
    function userback_install() {
        ...
        $sql = 'CREATE TABLE ' . $table_name . ' (
            ...
            t_logged_in_only        TINYINT(1)      NOT NULL,
    ...
    function get_array_userback() {
        ...
        foreach ($rows as $userback) {
            $response = array(
                ...
                'logged_in_only'  => (int)$userback->t_logged_in_only,
    ...
    function build_post_data_userback() {
        ...
        $userback_data = array(
            ...
            'logged_in_only'  => (isset($data['logged_in_only'])         ? $data['logged_in_only']     : 0),
    ...
    function save_userback() {
        ...
        if (isset($_POST['data'])) {
            ...
            $sql = 'INSERT INTO ' . $wpdb->prefix . 'userback (`t_page`, `t_is_active`, `t_logged_in_only`, `t_widget_code`) VALUES ('.
                '"' . esc_sql($data['page']) . '", ' .
                '"' . esc_sql($data['is_active']) . '", '.
                '"' . esc_sql($data['logged_in_only']) . '", '.
